...
class PlanarPointRobotSDFMultiObsExample{
    public:
        PlanarPointRobotSDFMultiObsExample(){
            /// map and sdf
            MatrixXd map_ground_truth = _matrix_io.load_csv("/home/hongzhe/git/VIMP/vimp/data/2d_pR/map_multiobs_entropy.csv");
            _field = _matrix_io.load_csv("/home/hongzhe/git/VIMP/vimp/data/2d_pR/field_multiobs_entropy.csv");
