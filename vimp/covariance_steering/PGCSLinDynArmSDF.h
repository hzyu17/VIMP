...
// class PGCSLinDynArmSDF: public ProxGradCovSteerLinDyn{
// public:
//     PGCSLinDynArmSDF(const MatrixXd& A0, 
//                     const VectorXd& a0, 
//                     const MatrixXd& B, 
...
//             hingeloss_gradient = _ArmSdf.hinge_jac(zi.block(0,0,_nx/2,1));
