...
TEST(TestPgcsSdf2D, initialization){
    ...
    /// reading XML configs
    rapidxml::file<> xmlFile("/home/hzyu/git/VIMP/vimp/covariance_steering/tests/data/test_config_dintegrator_map2.xml"); // Default template is char
    ...
    Kt_gt = m_io.load_csv("/home/hzyu/git/VIMP/vimp/covariance_steering/tests/data/Kt_sdf.csv");
    dt_gt = m_io.load_csv("/home/hzyu/git/VIMP/vimp/covariance_steering/tests/data/dt_sdf.csv");
    zkt_gt = m_io.load_csv("/home/hzyu/git/VIMP/vimp/covariance_steering/tests/data/zk_sdf.csv");
    Skt_gt = m_io.load_csv("/home/hzyu/git/VIMP/vimp/covariance_steering/tests/data/Sk_sdf.csv");
