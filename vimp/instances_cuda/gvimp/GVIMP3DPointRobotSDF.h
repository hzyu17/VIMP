...
using NGDFactorizedBaseGH = NGDFactorizedBaseGH_Cuda<CudaOperation_3dpR>;

class GVIMP3DPointRobotSDF{

public:
    virtual ~GVIMP3DPointRobotSDF(){}

    GVIMP3DPointRobotSDF(){}
