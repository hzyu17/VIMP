...
classdef SymbolicFactorGraph < handle
  ...
  methods
    function obj = SymbolicFactorGraph(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(560, varargin{2});
        end
        gtsam_wrapper(559, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(561);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicBayesNet')
        my_ptr = gtsam_wrapper(562, varargin{1});
    ...
    function delete(obj)
      gtsam_wrapper(564, obj.ptr_gtsamSymbolicFactorGraph);
    end
    ...
    function varargout = eliminatePartialMultifrontal(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Ordering')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(567, this, varargin{:});
