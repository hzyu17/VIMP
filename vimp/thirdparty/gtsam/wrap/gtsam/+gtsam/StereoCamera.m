  ...
  methods
    function obj = StereoCamera(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(526, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(527);
      elseif nargin == 2 && isa(varargin{1},'gtsam.Pose3') && isa(varargin{2},'gtsam.Cal3_S2Stereo')
        my_ptr = gtsam_wrapper(528, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(529, obj.ptr_gtsamStereoCamera);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(537, this, varargin{:});
      else
