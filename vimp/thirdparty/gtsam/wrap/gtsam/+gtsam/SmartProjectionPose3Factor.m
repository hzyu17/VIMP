...
classdef SmartProjectionPose3Factor < gtsam.NonlinearFactor
  ...
  methods
    ...
    function delete(obj)
      gtsam_wrapper(2728, obj.ptr_gtsamSmartProjectionPose3Factor);
    end
