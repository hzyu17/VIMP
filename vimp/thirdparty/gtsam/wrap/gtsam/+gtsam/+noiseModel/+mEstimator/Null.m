...
classdef Null < gtsam.noiseModel.mEstimator.Base
  ...
  methods
    function obj = Null(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(701, varargin{2});
        end
        base_ptr = gtsam_wrapper(700, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(702);
      else
    ...
    function delete(obj)
      gtsam_wrapper(703, obj.ptr_gtsamnoiseModelmEstimatorNull);
    end
  ...
  methods(Static = true)
    function varargout = Create(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(705, varargin{:});
    end
