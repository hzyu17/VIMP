...
\DoxyCodeLine{211         \}}
\DoxyCodeLine{212 }
\DoxyCodeLine{214         Eigen::MatrixXd \mbox{\hyperlink{classGaussianSampler_1_1Gaussian__distribution_a51d83dea00de66915fda8684af9619fa}{get\_precision}}()\{}
\DoxyCodeLine{215             \textcolor{keywordflow}{return} precision\_;}
\DoxyCodeLine{216         \}}
\DoxyCodeLine{217 }
\DoxyCodeLine{219         Eigen::VectorXd \mbox{\hyperlink{classGaussianSampler_1_1Gaussian__distribution_af9aceb3281a1b854165b3355c520e324}{get\_mean}}()\{}
\DoxyCodeLine{220             \textcolor{keywordflow}{return} mean\_;}
\DoxyCodeLine{221         \}}
\DoxyCodeLine{222 }
\DoxyCodeLine{224         Eigen::MatrixXd \mbox{\hyperlink{classGaussianSampler_1_1Gaussian__distribution_a24f7a59dafbaed55b4a364eecf65bba5}{get\_covariance}}()\{}
\DoxyCodeLine{225             \textcolor{keywordflow}{return} Covariance\_;}
\DoxyCodeLine{226         \}}
\DoxyCodeLine{227 }
\DoxyCodeLine{228     \textcolor{keyword}{protected}:}
\DoxyCodeLine{229         \textcolor{keywordtype}{int} dimension\_;}
\DoxyCodeLine{230         Eigen::VectorXd mean\_;}
\DoxyCodeLine{231         Eigen::MatrixXd Covariance\_;}
\DoxyCodeLine{232         Eigen::MatrixXd precision\_;}
\DoxyCodeLine{233 }
\DoxyCodeLine{234     \};}
\DoxyCodeLine{235 \}}
\DoxyCodeLine{236 }
\DoxyCodeLine{237 \textcolor{preprocessor}{\#endif }\textcolor{comment}{//C\_DRAFT\_MGVSAMPLER\_H}}
