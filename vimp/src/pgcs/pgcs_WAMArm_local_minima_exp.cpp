...
int main(){
    ...
    /// reading XML configs
    rapidxml::file<> xmlFile("/home/hongzhe/git/VIMP/vimp/configs/pgcs/wam_arm_local_minima.xml"); // Default template is char
    ...
    for (int i=1; i<4; i++){
        ...
        PGCSLinDynArmSDF pgcs_lin_sdf(A0, a0, B0, sig, nt, eta, eps, m0, Sig0, mT, SigT, pdyn, eps_sdf, sdf, sig_obs, Vscale);
