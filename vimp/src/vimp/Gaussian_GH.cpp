...
// using FactorizedOptimizer = GVIFactorizedGaussHermite<std::function<double(const VectorXd&, const Gaussian_distribution&)>, Gaussian_distribution>;
...
//     GVIGH<FactorizedOptimizer> optimizer(vec_factorized_opt);
