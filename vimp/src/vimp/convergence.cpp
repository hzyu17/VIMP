...
#include <vimp/gvimp/Optimizer.h>
...
/// Definition of a known Gaussian posterior
...
void test_coupled(){
    ...
    VIMPOptimizer<std::function<double(const gtsam::Vector&, const Gaussian_distribution&)>,
