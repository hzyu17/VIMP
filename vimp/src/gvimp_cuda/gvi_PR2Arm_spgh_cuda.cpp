...
#include "instances_cuda/gvimp/GVIMPPR2ArmSDF.h"
...
int main(int argc, char* argv[]){
    ...
    if (argc == 1){
        std::string config_file{source_root+"/configs/vimp/sparse_gh/pr2_bookshelf.xml"};
        GVIMPRunner7D<GVIMPPR2ArmSDF> runner(num_exp, config_file);
