...
start_confs = [-0.7, 0.175, -0.785, -1.047, -2.88, -0.6, 0.785;
              -1.9, 0.15, -2.18, -0.524, 3.14, -0.524, -1.047];
...
mean_last_gpmp = csvread([prefix+"/zk_gpmp2.csv"]);
...
inter_state = mean_last_gpmp(:, 325)'
position = arm.fk_model().forwardKinematicsPosition(inter_state')'
