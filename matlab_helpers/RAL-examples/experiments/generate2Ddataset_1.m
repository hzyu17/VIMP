...
if strcmp(dataset_str, '2LinkArmOneObstacleDataset')
    % params
    dataset.cols = 300;
    dataset.rows = 300;
    dataset.origin_x = -1;
...
elseif strcmp(dataset_str, '2LinkArmMultiObstacleDataset')
    % params
    dataset.cols = 400; %x
    dataset.rows = 300; %y
    dataset.origin_x = -20;
...
elseif strcmp(dataset_str, 'MultiObstacleEntropy')
    % params
    dataset.cols = 400; %x
    dataset.rows = 300; %y
    dataset.origin_x = -20;
...
elseif strcmp(dataset_str, 'PlannarPointRobotMultiObstacleMap2')
    % params
    dataset.cols = 400; %x
    dataset.rows = 300; %y
    dataset.origin_x = -20;
...
elseif strcmp(dataset_str, 'PlannarPointRobotNarrowMap')
    % params
    dataset.cols = 400; %x
    dataset.rows = 300; %y
    dataset.origin_x = -20;
...
elseif strcmp(dataset_str, '3LinkArmMap1')
    % params
    dataset.cols = 300;
    dataset.rows = 300;
    dataset.origin_x = -1;
