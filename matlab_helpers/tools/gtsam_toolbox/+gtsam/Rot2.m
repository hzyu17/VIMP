  ...
  methods
    function obj = Rot2(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(178, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(179);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(180, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(181, obj.ptr_gtsamRot2);
    end
    ...
    function varargout = matrix(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(189, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(190, this, varargin{:});
      else
