  ...
  methods
    function obj = Cal3_S2Stereo(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(447, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(448);
      elseif nargin == 6 && isa(varargin{1},'double') && isa(varargin{2},'double') && isa(varargin{3},'double') && isa(varargin{4},'double') && isa(varargin{5},'double') && isa(varargin{6},'double')
        my_ptr = gtsam_wrapper(449, varargin{1}, varargin{2}, varargin{3}, varargin{4}, varargin{5}, varargin{6});
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(450, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(451, obj.ptr_gtsamCal3_S2Stereo);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(457, this, varargin{:});
      else
