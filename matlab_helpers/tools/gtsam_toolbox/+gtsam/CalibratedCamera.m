  ...
  methods
    function obj = CalibratedCamera(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(483, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(484);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose3')
        my_ptr = gtsam_wrapper(485, varargin{1});
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(486, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(487, obj.ptr_gtsamCalibratedCamera);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(492, this, varargin{:});
      else
