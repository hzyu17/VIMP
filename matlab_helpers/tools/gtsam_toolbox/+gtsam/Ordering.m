  ...
  methods
    function obj = Ordering(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1082, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1083);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Ordering')
        my_ptr = gtsam_wrapper(1084, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1085, obj.ptr_gtsamOrdering);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1088, this, varargin{:});
      else
