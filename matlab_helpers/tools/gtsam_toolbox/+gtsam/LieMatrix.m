...
classdef LieMatrix < handle
  ...
  methods
    function obj = LieMatrix(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(95, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(96);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(97, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(98, obj.ptr_gtsamLieMatrix);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(106, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Expmap(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(109, varargin{:});
      else
    ...
    function varargout = Logmap(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.LieMatrix')
        varargout{1} = gtsam_wrapper(110, varargin{:});
      else
    ...
    function varargout = Identity(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(111, varargin{:});
    end
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(112, varargin{:});
      else
