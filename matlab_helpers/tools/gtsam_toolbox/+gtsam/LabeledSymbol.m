  ...
  methods
    function obj = LabeledSymbol(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1068, my_ptr);
      elseif nargin == 1 && isa(varargin{1},'numeric')
        my_ptr = gtsam_wrapper(1069, varargin{1});
      ...
      elseif nargin == 3 && isa(varargin{1},'char') && isa(varargin{2},'char') && isa(varargin{3},'numeric')
        my_ptr = gtsam_wrapper(1071, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1072, obj.ptr_gtsamLabeledSymbol);
    end
