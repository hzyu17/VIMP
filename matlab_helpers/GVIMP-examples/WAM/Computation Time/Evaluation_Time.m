...
% GPU times (in ms)
GPU_avg = [2.76667, 5.63333, 12.7, 19.8, 30.0667, 48.1, 78.8] / 1000;
GPU_min = [2, 4, 9, 16, 23, 40, 74];
GPU_max = [4, 7, 15, 26, 39, 56, 88];

% CPU times (in ms)
CPU_avg = [16.1, 30.3, 57.8, 161.75, 269.35, 547.35, 1002.4] / 1000;
...
% GPU times (in ms)
GPU_avg = [6.36667, 10.6333, 21.0333, 36.2333, 57.5667, 89.2667, 136] / 1000;
GPU_min = [5, 9, 18, 32, 52, 84, 131];
GPU_max = [8, 12, 25, 42, 72, 99, 143];

% CPU times (in ms)
CPU_avg = [93.4, 178.45, 343.15, 717.4, 1085.5, 1907.8, 3088.4] / 1000;
...
% GPU times (in ms)
GPU_avg = [14.9, 21.4333, 49.7667, 78.6667, 117.233, 203.533, 306.167] / 1000;
GPU_min = [12, 20, 41, 76, 112, 185, 284];
GPU_max = [18, 25, 56, 86, 122, 252, 384];

% CPU times (in ms)
CPU_avg = [294.65, 567.3, 1080.85, 2155.8, 3261.35, 5490.65, 8527.6] / 1000;
...
% exportgraphics(gcf, 'WAM_Time_Comparison.pdf', 'ContentType', 'vector', 'BackgroundColor', 'none');
