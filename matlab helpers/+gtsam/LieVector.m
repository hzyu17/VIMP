...
classdef LieVector < handle
  ...
  methods
    function obj = LieVector(varargin)
      ...
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(79, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(80, obj.ptr_gtsamLieVector);
    end
    ...
    function varargout = dim(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(83, this, varargin{:});
    end
  ...
  methods(Static = true)
    function varargout = Expmap(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(91, varargin{:});
      else
    ...
    function varargout = Logmap(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.LieVector')
        varargout{1} = gtsam_wrapper(92, varargin{:});
      else
