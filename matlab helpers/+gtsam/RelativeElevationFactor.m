...
classdef RelativeElevationFactor < gtsam.NoiseModelFactor
  ...
  methods
    function obj = RelativeElevationFactor(varargin)
      ...
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(282);
      elseif nargin == 4 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'double') && isa(varargin{4},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_unstable_wrapper(283, varargin{1}, varargin{2}, varargin{3}, varargin{4});
      else
    ...
    function delete(obj)
      gtsam_unstable_wrapper(284, obj.ptr_gtsamRelativeElevationFactor);
    end
    ...
    function varargout = measured(this, varargin)
      ...
      varargout{1} = gtsam_unstable_wrapper(285, this, varargin{:});
    end
