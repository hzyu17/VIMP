...
classdef Point2 < handle
  ...
  methods
    function obj = Point2(varargin)
      ...
      elseif nargin == 2 && isa(varargin{1},'double') && isa(varargin{2},'double')
        my_ptr = gtsam_wrapper(115, varargin{1}, varargin{2});
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(116, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(117, obj.ptr_gtsamPoint2);
    end
    ...
    function varargout = norm(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(120, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(121, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Identity(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(126, varargin{:});
    end
