...
inline double target_cost(const gtsam::Vector& sample,
...
int main(){
    ...
    // optimizer
    VariationalInferenceMPOptimizerFactorizedGaussHermite<std::function<double(const gtsam::Vector&, const Gaussian_distribution&)>,
