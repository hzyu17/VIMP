...
classdef StereoPoint2 < handle
  ...
  methods
    function obj = StereoPoint2(varargin)
      ...
      elseif nargin == 0
        my_ptr = gtsam_wrapper(145);
      elseif nargin == 3 && isa(varargin{1},'double') && isa(varargin{2},'double') && isa(varargin{3},'double')
        my_ptr = gtsam_wrapper(146, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(147, obj.ptr_gtsamStereoPoint2);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(153, this, varargin{:});
      else
  ...
  methods(Static = true)
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(163, varargin{:});
      else
