  ...
  methods
    function obj = VariableIndex(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(634, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(635);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicFactorGraph')
        my_ptr = gtsam_wrapper(636, varargin{1});
    ...
    function delete(obj)
      gtsam_wrapper(640, obj.ptr_gtsamVariableIndex);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(644, this, varargin{:});
      else
