...
%% ======================== Choices ======================== 
% "PlannarPointRobot", "2LinkArmOneObstacleDataset",
% "2LinkArmMultiObstacleDataset", "PlannarPointRobotNarrowMap",
% "PlannarPointRobotMultiObstacleMap2", 

dataset = generate2Ddataset_1('3LinkArmMap1');
rows = dataset.rows;
cols = dataset.cols;
...
% writematrix(dataset.map, '../vimp/data/2d_pR/map_multiobs_entropy_map3.csv') 
% writematrix(field, '../vimp/data/2d_pR/field_multiobs_entropy_map3.csv') 

writematrix(dataset.map, '3LinkArm/maps/map1.csv') 
writematrix(field, '3LinkArm/maps/field1.csv') 
